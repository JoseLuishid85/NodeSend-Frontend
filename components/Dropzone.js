...
const Dropzone = () => {
    ...
    const onDropRejected = () => {
        mostrarAlerta("No se Puede subir, el limite es 1MB, obten una cuenta para subir archivos más grandes")
    }
    ...
    const archivos = acceptedFiles.map(archivo => (
        <li key={archivo.lastModified} className="flex-1 p-3 mb-4 shadow-lg rounded">
                        ...
                        isDragActive ?
                            ...
                            <div className='text-center'>
                                ...
                                <button
                                    type='button'
                                    className='bg-blue-700 w-full py-3 rounded-lg text-white my-10 hover:bg-blue-800'
                                >Seleciona archivo para subir</button>
                            </div>
                    }
